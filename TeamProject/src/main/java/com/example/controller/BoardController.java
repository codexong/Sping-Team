...
public class BoardController {
	...
	public String writeBoard(@RequestParam("title") String title, @RequestParam("nickname") String nickname,
			@RequestParam("text") String text, @RequestParam("grade") String grade,
			@RequestParam("thumbnail") String thumbnail, RedirectAttributes redirectAttrs) throws Exception {
	...
	public String board(Model model, @RequestParam("title") String title, @RequestParam("thumbnail") String thumbnail) {
		try {
