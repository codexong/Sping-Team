...
public class BuyContoller {
	...
	// 구매페이지 이동
	@GetMapping("/buy")
	public String showBuyPage(Model model, HttpSession session, @RequestParam("realmName") String realmName,
			@RequestParam("title") String title, @RequestParam("place") String place,
